  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] w-full text-slate-100 p-6 relative overflow-hidden font-sans bg-transparent">
      ...
      >
        ...
        {userName ? (
          <div className="flex justify-between items-center bg-black/40 border border-white/5 p-4 rounded-2xl shadow-xl mt-1 backdrop-blur-sm">
          ...
          <button 
            ...
            className="w-full flex justify-center items-center space-x-2 p-4 mt-1 bg-black/40 border border-white/5 text-white/80 rounded-2xl shadow-xl hover:bg-white/10 active:scale-95 transition-all backdrop-blur-sm"
          >
            <GoogleIcon />
            <span className="font-bold text-sm tracking-wider">{toUpper(t('login_google'))}</span>
          </button>
        )}
